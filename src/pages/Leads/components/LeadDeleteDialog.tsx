...
const LeadDeleteDialog: React.FC<LeadDeleteDialogProps> = ({ open, onClose, onConfirm, deleting }) => (
  <Dialog open={open} onClose={deleting ? undefined : onClose} maxWidth="xs" fullWidth PaperProps={{ sx: dialogPaperSx }}>
    ...
    <DialogActions sx={{ px: 3, pb: 2 }}>
      <Button onClick={onClose} disabled={deleting} sx={{ color: 'rgba(255,255,255,0.7)' }}>
        Отмена
      </Button>
