...
const NoteEditDialog: React.FC<NoteEditDialogProps> = ({ open, onClose, onSubmit, content, onContentChange, saving }) => (
  <Dialog open={open} onClose={saving ? undefined : onClose} maxWidth="sm" fullWidth PaperProps={{ sx: dialogPaperSx }}>
    <DialogTitle sx={dialogTitleSx}>Редактировать заметку</DialogTitle>
